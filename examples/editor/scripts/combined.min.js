(function(b){function g(){}function k(a){if(!a)return 0;a=a.split(".");return 1E4*parseInt(a[0])+100*parseInt(a[1])+parseInt(a[2])}function i(a){for(var a=a.replace(/-/g,"_"),a=a.split("."),c=f,d=0;d<a.length;d++)c[a[d]]===void 0&&(c[a[d]]=new g),c=c[a[d]];return c}var f=b.namespace;if(f){if(k("3.0.1")<=k(f.VERSION))return;g=f.constructor}else b.namespace=f=new g;f.VERSION="3.0.1";b=g.prototype;b.module=function(a,c){var d=i(a);c&&c(d,i);return d};b.extend=function(a){for(var c in a)a.hasOwnProperty(c)&&
(this[c]=a[c])}})(this);
namespace.module("org.startpad.types",function(b){function g(a,c){return k(a)==c}function k(a){if(a===void 0)return"undefined";if(a===null)return"null";var c=Object.prototype.toString.call(a).match(/\[object (.*)\]/)[1].toLowerCase();f.indexOf(c)==-1&&(c=typeof a);return c}function i(a){var c=[],e;for(e in a)a.hasOwnProperty(e)&&c.push(e);return c}b.extend({VERSION:"0.2.2",isArguments:function(a){return g(a,"arguments")},isArray:function(a){return g(a,"array")},copyArray:function(a){return Array.prototype.slice.call(a)},isType:g,
...
i,patch:function(){Object.keys=Object.keys||i;return b}});var f="number,string,boolean,array,function,date,regexp,arguments,undefined,null".split(","),a=!{toString:!0}.propertyIsEnumerable("toString"),c=["toString","toLocaleString","valueOf","constructor","isPrototypeOf"]});
namespace.module("org.startpad.funcs",function(b,g){function k(a){if(!a)return 0;a=a.split(".");return 1E4*parseInt(a[0])+100*parseInt(a[1])+parseInt(a[2])}function i(a,c,d,e){if(!(a._patches&&k(a._patches[c])>=k(d)))a._patches=a._patches||{},a._patches[c]=d,f(a,e)}function f(a,c){l.extend(a.prototype,c)}function a(a,c){function d(a,c){for(var e=l.copyArray(a),c=l.copyArray(c),j=0;j<e.length;j++)e[j]===void 0&&(e[j]=c.shift());return e.concat(c)}var e;e=arguments.length==3&&l.isArguments(arguments[2])?
Array.prototype.slice.call(arguments[2],self1):Array.prototype.slice.call(arguments,2);return function(){return a.apply(c||this,d(e,arguments))}}function c(a,c){function d(){return c.call(this,a,arguments,d)}c.call(a,void 0,arguments,d);return d}function d(a){function c(){}c.prototype=a;return new c}function h(a,c,d){a.prototype=b.create(c.prototype);a.prototype.constructor=a;f(a,d);return a}function e(a,c){for(var d=a.pop().prototype,e;a.length>0;){e=a.pop();var h=l.getFunctionName(e),q=b.create(d);
l.extend(q,e.prototype);q.constructor=e;q[h+"_super"]=d;d=q}e.prototype=d;f(e,c)}var l=g("org.startpad.types");b.extend({VERSION:"0.3.1",methods:f,bind:a,decorate:c,create:Object.create||d,subclass:h,mro:e,numericVersion:k,monkeyPatch:i,patch:function(){if(!Object.create)Object.create=d;i(Function,"org.startpad.funcs",b.VERSION,{methods:function(a){f(this,a)},curry:function(){var c=[this,void 0].concat(l.copyArray(arguments));return a.apply(void 0,c)},curryThis:function(c){var d=l.copyArray(arguments);
...
namespace.module("org.startpad.string",function(b,g){function k(a,c,d){d=d||f;if(a==void 0)return"undefined";a=a.toString();return a=a.replace(d,function(a,d){for(var b=c,f=d.split("."),n=0;n<f.length;n++){var d=f[n],j=parseInt(d),b=isNaN(j)?b[d]:b[j];if(b==void 0)return""}return b})}var i=g("org.startpad.funcs");b.extend({VERSION:"0.3.0",patch:function(){i.monkeyPatch(String,"org.startpad.string",b.VERSION,{format:function(){return arguments.length==1&&typeof arguments[0]=="object"?k(this,arguments[0]):
k(this,arguments)}});return b},format:k,strip:function(a){return(a||"").replace(/^\s+|\s+$/g,"")}});var f=/\{\s*([^} ]+)\s*\}/g});namespace.module("com.pageforest.editor.codemirror",function(b){var g;b.extend({isProbablySupported:function(){return CodeMirror.isProbablySupported()&&!navigator.userAgent.match(/^Mozilla.5.0 .iPad/)},createEditor:function(b,i){var f={path:"/codemirror/js/",width:"100%",height:"100px",content:i},a=b.toLowerCase();a.substr(-5)==".html"?(f.stylesheet=["/codemirror/css/xmlcolors.css","/codemirror/css/jscolors.css","/codemirror/css/csscolors.css"],f.parserfile=["parsexml.js","parsecss.js","tokenizejavascript.js",
...
f.parser="DummyParser");a=$('<textarea id="code"></textarea>');$("#content").empty().append(a);g=window.CodeMirror.fromTextArea("code",f)},adjustHeight:function(){if(g&&g.editor){var b=g.editor.container.scrollHeight;$(".CodeMirror-wrapping").css("height",b+"px")}},getData:function(){return g.getCode()},codemirror:g})});namespace.module("com.pageforest.editor",function(b){function g(a){$("#status").text(a)}function k(a){g(a.status+" "+a.statusText)}function i(){var a=[];a.push('<a href="#">apps</a>');a.push('<span class="quiet">/</span>');if(j.app_id){a.push('<a href="#'+j.app_id+'">'+j.app_id+"</a>");a.push('<span class="quiet">/</span>');for(var c="#"+j.app_id+"/",d=j.filename.split("/"),e=0;d[e];e++){var h=d[e];c+=h;e<d.length-1&&(c+="/");a.push('<a href="'+c+'">'+h+"</a>");c.substr(-1)=="/"&&a.push('<span class="quiet">/</span>')}}$("#breadcrumbs").html(a.join("\n"))}
function f(){i();j.editor.view("hide");var a=j.filename;a.substr(-1)=="/"&&(a=a.substr(0,a.length-1));console.log("showFiles: "+j.listing+" "+a);var c=[],d=a;d.substr(-1)=="/"&&(d=d.substr(0,d.length-1));var e=d.length||-1,h=[],b;for(b in j.listing)if(j.listing.hasOwnProperty(b)&&(d==""||b.charAt(e)=="/"&&b.substr(0,d.length)==d)){var f=b.substr(e+1).split("/");f.length==1?h.push(f[0]):(f=f[0]+"/",h.indexOf(f)==-1&&h.push(f))}for(d=0;d<h.length;d++){e=h[d];b=j.app_id+"/"+(a?a+"/":"")+e;f=b;if(f.substr(-1)==
"/")f='<img width="83" height="64" src="/icons/64/folder.png" alt="" />';else if(f.substr(-4)==".png")f='<img height="64" src="/mirror/'+f+'" alt="" />';else{var l="txt",m=f.lastIndexOf(".");m>0&&(l=f.substr(m+1).toLowerCase(),l=="json"&&(l="js"));f='<img width="54" height="64" src="/icons/64/'+l+'.png" alt="" />'}c.push('<div class="icon">');c.push('<a href="#'+b+'">'+f+"</a><br />");c.push('<a href="#'+b+'">'+e+"</a>");c.push("</div>")}h="/mirror/"+j.app_id+"/post?path="+a;c.push('<div style="width:100%; height:10em; clear:both">');
c.push('<iframe class="upload" src="'+h+'" style="width:100%; height:100%; border:none"></iframe>');c.push("</div>");$("#content").html(c.join("\n"));g("Loaded directory: "+j.app_id+"/"+a)}function a(){j.app_id="";console.log("loadAppList");$.ajax({url:"/mirror?method=list",dataType:"json",success:function(a){i();j.appListing=a.items;if(!j.app_id){j.editor.view("hide");var a=[],c;for(c in j.appListing)if(j.appListing.hasOwnProperty(c)){var d=j.appListing[c].icon?'<img width="64" height="64" src="/mirror/'+
c+"/"+j.appListing[c].icon+'" alt="" />':'<img width="83" height="64" src="/icons/64/folder.png" alt="" />';a.push('<div class="icon">');a.push('<a href="#'+c+'">'+d+"</a><br />");a.push('<a href="#'+c+'">'+c+"</a>");a.push("</div>")}$("#content").html(a.join("\n"));g("Loaded app list")}},error:function(a,c,d){a.status==403?($("#content").empty(),$("#status").html('<span class="error">Please sign in to edit your apps.</span>')):k(a,c,d)}})}function c(a){j.app_id=a;$.ajax({url:"/mirror/"+j.app_id+
"?method=list&depth=0",dataType:"json",error:k,success:function(a){i();j.listing=a.items;(!j.filename||j.filename.substr(-1)=="/")&&f()}})}function d(a){j.filename=a;a==""||a.substr(-1)=="/"?f():$.ajax({url:"/mirror/"+j.app_id+"/"+j.filename,dataType:"text",error:k,success:function(a){o=a;i();$("#content").empty();j.editor.loadFile(j.filename,a);j.editor.adjustHeight("shrink");j.editor.view("show");g("Loaded file: "+j.filename)}})}function h(){var a=$("iframe.upload")[0];a&&(a=a.contentWindow.document.body.innerHTML.replace(/<\/?[^>]+>\s*/gi,
""),a.substr(0,1)=="{"&&JSON.parse(a).status==200&&c(j.app_id))}function e(){var e=window.location.hash;if(e==j.hash)j.editor.view()&&j.editor.adjustHeight();else{j.hash=e;var h=e.substr(1).split("/");console.log("parts: ["+h+"]");e=h.shift();h=h.join("/");console.log("app_id: ["+e+"]");e?e!=j.app_id?(c(e),h?d(h):j.filename=""):h!=j.filename&&d(h):a()}}function l(){console.log("setEditor()");if(j.editor.view()){var a=j.editor.getData();j.editor.view("hide");j.editor=j[$("#editor").val()];j.editor.loadFile(j.filename,
a);j.editor.view("show")}else j.editor=j[$("#editor").val()]}function m(){!p&&j.editor.view()&&o!=j.editor.getData()&&(p=!0)}function n(){var a=$("#ace"),c=$("#textarea");a.css("height",window.innerHeight-43+"px");a.css("width",window.innerWidth+"px");c.css("height",window.innerHeight-43+"px");c.css("width",window.innerWidth-15+"px")}var j={},o,p;b.extend({onReady:function(){var a=namespace.lookup("com.pageforest.client");j.client=new a.Client(b);j.client.saveInterval=0;j.client.state="clean";j.hash=
"###";j.app_id="";j.filename="";setInterval(e,200);setInterval(h,1E3);setInterval(m,5E3);j.ace=namespace.lookup("com.pageforest.editor.ace");j.ace.createEditor();j.ace.view("hide");j.textarea=namespace.lookup("com.pageforest.editor.textarea");j.textarea.view("hide");var a=j,c;c=!1;/Android|iPad|iPod|iPhone/.test(navigator.userAgent)&&(c=!0);c?($("#editor").val("textarea"),c=j.textarea):($("#editor").val("ace"),c=j.ace);a.editor=c;$(window).bind("resize",n);$("#editor").change(l)},onSave:function(){$.ajax({type:"PUT",
url:"/mirror/"+j.app_id+"/"+j.filename,data:j.editor.getData(),dataType:"text",success:function(a){g(a)},error:k})},onUserChange:function(c){console.log("onUserChange("+c+");");c==void 0?($("#username").text("anonymous"),$("#signin").text("Sign in").attr("href","http://www.pageforest.com/sign-in/editor")):($("#username").text(c),$("#signin").text("Sign out").attr("href","http://www.pageforest.com/sign-out/editor"));j.app_id||a()},onSignInOut:function(){j.client.username!=void 0?j.client.signOut():
j.client.signIn()},appListing:j.appListing,listing:j.listing,app_id:j.app_id,filename:j.filename,editor:j.editor,hash:j.hash,client:j.client})});namespace.module("com.pageforest.editor.textarea",function(b){function g(b){console.log("adjustScroll event: ",b)}var k=!1;b.extend({createEditor:function(){},loadFile:function(b,f){var a=$('<textarea id="code" spellcheck="false" autocorrect="off" ></textarea>');$("#textarea").empty().append(a);a.val(f).focus();a.bind("touchstart",g)},adjustHeight:function(b){console.log("adjustHeight() within textarea");for(var f=$("#code"),a=f.attr("scrollHeight"),c=f.attr("offsetHeight");b&&c&&a==c;)f.css("height",
c/2+"px"),a=f.attr("scrollHeight"),c=f.attr("offsetHeight");a>c&&f.css("height",a+"px")},getData:function(){return $("#textarea").find("textarea").val()},view:function(b){return b=="show"?(k=!0,$("#textarea").css("display","block"),!0):b=="hide"?(k=!1,$("#textarea").css("display","none"),!1):k}})});define("ace/mode/javascript","require,exports,module,pilot/oop,ace/mode/text,ace/tokenizer,ace/mode/javascript_highlight_rules,ace/mode/matching_brace_outdent,ace/range,ace/worker/worker_client,ace/mode/behaviour/cstyle".split(","),function(b,g){var k=b("pilot/oop"),i=b("ace/mode/text").Mode,f=b("ace/tokenizer").Tokenizer,a=b("ace/mode/javascript_highlight_rules").JavaScriptHighlightRules,c=b("ace/mode/matching_brace_outdent").MatchingBraceOutdent,d=b("ace/range").Range,h=b("ace/worker/worker_client").WorkerClient,
...
regex:'(?:(?:\\\\.)|(?:[^"\\\\]))*?"',next:"start"},{token:"string",merge:!0,regex:".+"}],qstring:[{token:"string",regex:"(?:(?:\\\\.)|(?:[^'\\\\]))*?'",next:"start"},{token:"string",merge:!0,regex:".+"}]};this.embedRules(a,"doc-",[(new a).getEndRule("start")])};k.inherits(d,c);g.JavaScriptHighlightRules=d});
define("ace/mode/doc_comment_highlight_rules",["require","exports","module","pilot/oop","ace/mode/text_highlight_rules"],function(b,g){var k=b("pilot/oop"),i=b("ace/mode/text_highlight_rules").TextHighlightRules,f=function(){this.$rules={start:[{token:"comment.doc.tag",regex:"@[\\w\\d_]+"},{token:"comment.doc",merge:!0,regex:"\\s+"},{token:"comment.doc",merge:!0,regex:"TODO"},{token:"comment.doc",merge:!0,regex:"[^@\\*]+"},{token:"comment.doc",merge:!0,regex:"."}]}};k.inherits(f,i);(function(){this.getStartRule=
function(a){return{token:"comment.doc",merge:!0,regex:"\\/\\*(?=\\*)",next:a}};this.getEndRule=function(a){return{token:"comment.doc",merge:!0,regex:"\\*\\/",next:a}}}).call(f.prototype);g.DocCommentHighlightRules=f});
define("ace/mode/matching_brace_outdent",["require","exports","module","ace/range"],function(b,g){var k=b("ace/range").Range,i=function(){};(function(){this.checkOutdent=function(b,a){return/^\s+$/.test(b)?/^\s*\}/.test(a):!1};this.autoOutdent=function(b,a){var c=b.getLine(a).match(/^(\s*\})/);if(!c)return 0;var c=c[1].length,d=b.findMatchingBracket({row:a,column:c});if(!d||d.row==a)return 0;d=this.$getIndent(b.getLine(d.row));b.replace(new k(a,0,a,c-1),d)};this.$getIndent=function(b){return(b=b.match(/^(\s+)/))?
b[1]:""}}).call(i.prototype);g.MatchingBraceOutdent=i});
define("ace/worker/worker_client",["require","exports","module","pilot/oop","pilot/event_emitter"],function(b,g){var k=b("pilot/oop"),i=b("pilot/event_emitter").EventEmitter,f=function(a,c,d,h){this.callbacks=[];if(b.packaged)a=this.$guessBasePath(),this.$worker=new Worker(a+c);else{var e=this.$normalizePath(b.nameToUrl("ace/worker/worker",null,"_"));this.$worker=new Worker(e);e={};for(c=0;c<a.length;c++){var f=a[c],m=this.$normalizePath(b.nameToUrl(f,null,"_").replace(/.js$/,""));e[f]=m}}this.$worker.postMessage({init:!0,
tlns:e,module:d,classname:h});this.callbackId=1;this.callbacks={};var i=this;this.$worker.onerror=function(a){throw window.console&&console.log&&console.log(a),a;};this.$worker.onmessage=function(a){a=a.data;switch(a.type){case "log":window.console&&console.log&&console.log(a.data);break;case "event":i._dispatchEvent(a.name,{data:a.data});break;case "call":var c=i.callbacks[a.id];c&&(c(a.data),delete i.callbacks[a.id])}}};(function(){k.implement(this,i);this.$normalizePath=function(a){return a.match(/^\w+:/)||
...
{});this.$worker.terminate()};this.send=function(a,c){this.$worker.postMessage({command:a,args:c})};this.call=function(a,c,d){if(d){var h=this.callbackId++;this.callbacks[h]=d;c.push(h)}this.send(a,c)};this.emit=function(a,c){this.$worker.postMessage({event:a,data:c})}}).call(f.prototype);g.WorkerClient=f});
define("ace/mode/behaviour/cstyle",["require","exports","module","pilot/oop","ace/mode/behaviour"],function(b,g){var k=b("pilot/oop"),i=b("ace/mode/behaviour").Behaviour,f=function(){this.add("braces","insertion",function(a,c,d,h,e){if(e=="{")return a=d.getSelectionRange(),h=h.doc.getTextRange(a),h!==""?{text:"{"+h+"}",selection:!1}:{text:"{}",selection:[1,1]};if(e=="}"){if(d=d.getCursorPosition(),c=h.doc.getLine(d.row),e=c.substring(d.column,d.column+1),e=="}"&&h.$findOpeningBracket("}",{column:d.column+
...
return!e.isMultiLine()&&a=='"'&&b.doc.getLine(e.start.row).substring(e.start.column+1,e.start.column+2)=='"'?(e.end.column++,e):!1})};k.inherits(f,i);g.CstyleBehaviour=f});define("ace/mode/html","require,exports,module,pilot/oop,ace/mode/text,ace/mode/javascript,ace/mode/css,ace/tokenizer,ace/mode/html_highlight_rules,ace/mode/behaviour/xml".split(","),function(b,g){var k=b("pilot/oop"),i=b("ace/mode/text").Mode,f=b("ace/mode/javascript").Mode,a=b("ace/mode/css").Mode,c=b("ace/tokenizer").Tokenizer,d=b("ace/mode/html_highlight_rules").HtmlHighlightRules,h=b("ace/mode/behaviour/xml").XmlBehaviour,e=function(){var e=new d;this.$tokenizer=new c(e.getRules());this.$behaviour=
new h;this.$embeds=e.getEmbeds();this.createModeDelegates({"js-":f,"css-":a})};k.inherits(e,i);(function(){this.toggleCommentLines=function(){return 0};this.getNextLineIndent=function(a,c){return this.$getIndent(c)};this.checkOutdent=function(){return!1}}).call(e.prototype);g.Mode=e});
...
function(){a.clearAnnotations()}),d}}).call(l.prototype);g.Mode=l});
define("ace/mode/javascript_highlight_rules","require,exports,module,pilot/oop,pilot/lang,ace/unicode,ace/mode/doc_comment_highlight_rules,ace/mode/text_highlight_rules".split(","),function(b,g){var k=b("pilot/oop"),i=b("pilot/lang"),f=b("ace/unicode"),a=b("ace/mode/doc_comment_highlight_rules").DocCommentHighlightRules,c=b("ace/mode/text_highlight_rules").TextHighlightRules,d=function(){var c=i.arrayToMap("break|case|catch|continue|default|delete|do|else|finally|for|function|if|in|instanceof|new|return|switch|throw|try|typeof|let|var|while|with|const|yield|import|get|set".split("|")),d=
i.arrayToMap("null|Infinity|NaN|undefined".split("|")),b=i.arrayToMap("class|enum|extends|super|export|implements|private|public|interface|package|protected|static".split("|")),g="["+f.packages.L+"\\$_]["+f.packages.L+f.packages.Mn+f.packages.Mc+f.packages.Nd+f.packages.Pc+"\\$_]*\\b";this.$rules={start:[{token:"comment",regex:"\\/\\/.*$"},(new a).getStartRule("doc-start"),{token:"comment",merge:!0,regex:"\\/\\*",next:"comment"},{token:"string",regex:'["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]'},{token:"string",
merge:!0,regex:'["].*\\\\$',next:"qqstring"},{token:"string",regex:"['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']"},{token:"string",merge:!0,regex:"['].*\\\\$",next:"qstring"},{token:"constant.numeric",regex:"0[xX][0-9a-fA-F]+\\b"},{token:"constant.numeric",regex:"[+-]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?\\b"},{token:["keyword","text","entity.name.function"],regex:"(function)(\\s+)("+g+")"},{token:"constant.language.boolean",regex:"(?:true|false)\\b"},{token:"keyword",regex:"(?:case|do|else|finally|in|instanceof|return|throw|try|typeof|yield)\\b",
next:"regex_allowed"},{token:function(a){return a=="this"?"variable.language":c.hasOwnProperty(a)?"keyword":d.hasOwnProperty(a)?"constant.language":b.hasOwnProperty(a)?"invalid.illegal":a=="debugger"?"invalid.deprecated":"identifier"},regex:g},{token:"keyword.operator",regex:"!|\\$|%|&|\\*|\\-\\-|\\-|\\+\\+|\\+|~|===|==|=|!=|!==|<=|>=|<<=|>>=|>>>=|<>|<|>|!|&&|\\|\\||\\?\\:|\\*=|%=|\\+=|\\-=|&=|\\^=|\\b(?:in|instanceof|new|delete|typeof|void)",next:"regex_allowed"},{token:"lparen",regex:"[[({]",next:"regex_allowed"},
{token:"rparen",regex:"[\\])}]"},{token:"keyword.operator",regex:"\\/=?",next:"regex_allowed"},{token:"comment",regex:"^#!.*$"},{token:"text",regex:"\\s+"}],regex_allowed:[{token:"comment",regex:"\\/\\/.*$"},{token:"string.regexp",regex:"\\/(?:(?:\\[(?:\\\\]|[^\\]])+\\])|(?:\\\\/|[^\\]/]))*[/]\\w*",next:"start"},{token:"text",regex:"\\s+"},{token:"empty",regex:"",next:"start"}],comment:[{token:"comment",regex:".*?\\*\\/",next:"start"},{token:"comment",merge:!0,regex:".+"}],qqstring:[{token:"string",
regex:'(?:(?:\\\\.)|(?:[^"\\\\]))*?"',next:"start"},{token:"string",merge:!0,regex:".+"}],qstring:[{token:"string",regex:"(?:(?:\\\\.)|(?:[^'\\\\]))*?'",next:"start"},{token:"string",merge:!0,regex:".+"}]};this.embedRules(a,"doc-",[(new a).getEndRule("start")])};k.inherits(d,c);g.JavaScriptHighlightRules=d});
define("ace/mode/doc_comment_highlight_rules",["require","exports","module","pilot/oop","ace/mode/text_highlight_rules"],function(b,g){var k=b("pilot/oop"),i=b("ace/mode/text_highlight_rules").TextHighlightRules,f=function(){this.$rules={start:[{token:"comment.doc.tag",regex:"@[\\w\\d_]+"},{token:"comment.doc",merge:!0,regex:"\\s+"},{token:"comment.doc",merge:!0,regex:"TODO"},{token:"comment.doc",merge:!0,regex:"[^@\\*]+"},{token:"comment.doc",merge:!0,regex:"."}]}};k.inherits(f,i);(function(){this.getStartRule=
function(a){return{token:"comment.doc",merge:!0,regex:"\\/\\*(?=\\*)",next:a}};this.getEndRule=function(a){return{token:"comment.doc",merge:!0,regex:"\\*\\/",next:a}}}).call(f.prototype);g.DocCommentHighlightRules=f});
define("ace/mode/matching_brace_outdent",["require","exports","module","ace/range"],function(b,g){var k=b("ace/range").Range,i=function(){};(function(){this.checkOutdent=function(b,a){return/^\s+$/.test(b)?/^\s*\}/.test(a):!1};this.autoOutdent=function(b,a){var c=b.getLine(a).match(/^(\s*\})/);if(!c)return 0;var c=c[1].length,d=b.findMatchingBracket({row:a,column:c});if(!d||d.row==a)return 0;d=this.$getIndent(b.getLine(d.row));b.replace(new k(a,0,a,c-1),d)};this.$getIndent=function(b){return(b=b.match(/^(\s+)/))?
b[1]:""}}).call(i.prototype);g.MatchingBraceOutdent=i});
define("ace/worker/worker_client",["require","exports","module","pilot/oop","pilot/event_emitter"],function(b,g){var k=b("pilot/oop"),i=b("pilot/event_emitter").EventEmitter,f=function(a,c,d,h){this.callbacks=[];if(b.packaged)a=this.$guessBasePath(),this.$worker=new Worker(a+c);else{var e=this.$normalizePath(b.nameToUrl("ace/worker/worker",null,"_"));this.$worker=new Worker(e);e={};for(c=0;c<a.length;c++){var f=a[c],i=this.$normalizePath(b.nameToUrl(f,null,"_").replace(/.js$/,""));e[f]=i}}this.$worker.postMessage({init:!0,
tlns:e,module:d,classname:h});this.callbackId=1;this.callbacks={};var g=this;this.$worker.onerror=function(a){throw window.console&&console.log&&console.log(a),a;};this.$worker.onmessage=function(a){a=a.data;switch(a.type){case "log":window.console&&console.log&&console.log(a.data);break;case "event":g._dispatchEvent(a.name,{data:a.data});break;case "call":var c=g.callbacks[a.id];c&&(c(a.data),delete g.callbacks[a.id])}}};(function(){k.implement(this,i);this.$normalizePath=function(a){return a.match(/^\w+:/)||
(a=location.protocol+"//"+location.host+(a.charAt(0)=="/"?"":location.pathname.replace(/\/[^\/]*$/,""))+"/"+a.replace(/^[\/]+/,"")),a};this.$guessBasePath=function(){if(b.aceBaseUrl)return b.aceBaseUrl;for(var a=document.getElementsByTagName("script"),c=0;c<a.length;c++){var d=a[c],h=d.getAttribute("data-ace-base");if(h)return h.replace(/\/*$/,"/");if(d=d.src||d.getAttribute("src"))if(d=d.match(/^(?:(.*\/)ace\.js|(.*\/)ace-uncompressed\.js)(?:\?|$)/))return d[1]||d[2]}return""};this.terminate=function(){this._dispatchEvent("terminate",
{});this.$worker.terminate()};this.send=function(a,c){this.$worker.postMessage({command:a,args:c})};this.call=function(a,c,d){if(d){var b=this.callbackId++;this.callbacks[b]=d;c.push(b)}this.send(a,c)};this.emit=function(a,c){this.$worker.postMessage({event:a,data:c})}}).call(f.prototype);g.WorkerClient=f});
...
i=-1,g=0;g<b.length;g++){f=b[g];f.type=="string"?i=-1:i<0&&(i=f.value.indexOf('"'));if(f.value.length+e>a.start.column)break;e+=b[g].value.length}if(!f||i<0&&f.type!=="comment"&&(f.type!=="string"||a.start.column!==f.value.length+e-1&&f.value.lastIndexOf('"')===f.value.length-1))return{text:'""',selection:[1,1]};if(f&&f.type==="string"&&c.substring(d.column,d.column+1)=='"')return{text:"",selection:[1,1]}}return!1});this.add("string_dquotes","deletion",function(a,c,d,b,e){a=b.doc.getTextRange(e);
return!e.isMultiLine()&&a=='"'&&b.doc.getLine(e.start.row).substring(e.start.column+1,e.start.column+2)=='"'?(e.end.column++,e):!1})};k.inherits(f,i);g.CstyleBehaviour=f});
define("ace/mode/css","require,exports,module,pilot/oop,ace/mode/text,ace/tokenizer,ace/mode/css_highlight_rules,ace/mode/matching_brace_outdent,ace/worker/worker_client".split(","),function(b,g){var k=b("pilot/oop"),i=b("ace/mode/text").Mode,f=b("ace/tokenizer").Tokenizer,a=b("ace/mode/css_highlight_rules").CssHighlightRules,c=b("ace/mode/matching_brace_outdent").MatchingBraceOutdent,d=b("ace/worker/worker_client").WorkerClient,h=function(){this.$tokenizer=new f((new a).getRules());this.$outdent=
...
k=i.copyArray(g);k.unshift({token:"rparen",regex:"\\}",next:"start"});g=i.copyArray(g);g.unshift({token:"rparen",regex:"\\}",next:"media"});var j=[{token:"comment",merge:!0,regex:".+"}],o=i.copyArray(j);o.unshift({token:"comment",regex:".*?\\*\\/",next:"start"});var p=i.copyArray(j);p.unshift({token:"comment",regex:".*?\\*\\/",next:"media"});j=i.copyArray(j);j.unshift({token:"comment",regex:".*?\\*\\/",next:"ruleset"});this.$rules={start:[{token:"comment",merge:!0,regex:"\\/\\*",next:"comment"},{token:"lparen",
...
{token:"text",regex:"(?:[^\\]]|\\](?!\\]>))+"}],comment:[{token:"comment",regex:".*?--\>",next:"start"},{token:"comment",merge:!0,regex:".+"}]}};k.inherits(f,i);g.XmlHighlightRules=f});
define("ace/mode/behaviour/xml","require,exports,module,pilot/oop,ace/mode/behaviour,ace/mode/behaviour/cstyle".split(","),function(b,g){var k=b("pilot/oop"),i=b("ace/mode/behaviour").Behaviour,f=b("ace/mode/behaviour/cstyle").CstyleBehaviour,a=function(){this.inherit(f,["string_dquotes"]);this.add("brackets","insertion",function(a,b,f,e,g){if(g=="<")return a=f.getSelectionRange(),e.doc.getTextRange(a)!==""?!1:{text:"<>",selection:[1,1]};if(g==">"){if(a=f.getCursorPosition(),b=e.doc.getLine(a.row),
b.substring(a.column,a.column+1)==">")return{text:"",selection:[1,1]}}else if(g=="\n"&&(a=f.getCursorPosition(),b=e.doc.getLine(a.row),b.substring(a.column,a.column+2)=="</"))return b=this.$getIndent(e.doc.getLine(a.row))+e.getTabString(),e=this.$getIndent(e.doc.getLine(a.row)),{text:"\n"+b+"\n"+e,selection:[1,b.length,1,b.length]};return!1})};k.inherits(a,i);g.XmlBehaviour=a});
...
[b.getValue()]);b.on("change",function(a){a.range={start:a.data.range.start,end:a.data.range.end};c.emit("change",a)});c.on("csslint",function(b){var c=[];b.data.forEach(function(a){c.push({row:a.line-1,column:a.col-1,text:a.message,type:a.type,lint:a})});a.setAnnotations(c)})}}).call(h.prototype);g.Mode=h});
define("ace/mode/css_highlight_rules","require,exports,module,pilot/oop,pilot/lang,ace/mode/text_highlight_rules".split(","),function(b,g){var k=b("pilot/oop"),i=b("pilot/lang"),f=b("ace/mode/text_highlight_rules").TextHighlightRules,a=function(){function a(b){for(var c=[],b=b.split(""),d=0;d<b.length;d++)c.push("[",b[d].toLowerCase(),b[d].toUpperCase(),"]");return c.join("")}var b=i.arrayToMap("-moz-box-sizing|-webkit-box-sizing|appearance|azimuth|background-attachment|background-color|background-image|background-position|background-repeat|background|border-bottom-color|border-bottom-style|border-bottom-width|border-bottom|border-collapse|border-color|border-left-color|border-left-style|border-left-width|border-left|border-right-color|border-right-style|border-right-width|border-right|border-spacing|border-style|border-top-color|border-top-style|border-top-width|border-top|border-width|border|bottom|box-sizing|caption-side|clear|clip|color|content|counter-increment|counter-reset|cue-after|cue-before|cue|cursor|direction|display|elevation|empty-cells|float|font-family|font-size-adjust|font-size|font-stretch|font-style|font-variant|font-weight|font|height|left|letter-spacing|line-height|list-style-image|list-style-position|list-style-type|list-style|margin-bottom|margin-left|margin-right|margin-top|marker-offset|margin|marks|max-height|max-width|min-height|min-width|-moz-border-radius|opacity|orphans|outline-color|outline-style|outline-width|outline|overflow|overflow-x|overflow-y|padding-bottom|padding-left|padding-right|padding-top|padding|page-break-after|page-break-before|page-break-inside|page|pause-after|pause-before|pause|pitch-range|pitch|play-during|position|quotes|richness|right|size|speak-header|speak-numeral|speak-punctuation|speech-rate|speak|stress|table-layout|text-align|text-decoration|text-indent|text-shadow|text-transform|top|unicode-bidi|vertical-align|visibility|voice-family|volume|white-space|widows|width|word-spacing|z-index".split("|")),
f=i.arrayToMap("rgb|rgba|url|attr|counter|counters".split("|")),e=i.arrayToMap("absolute|all-scroll|always|armenian|auto|baseline|below|bidi-override|block|bold|bolder|border-box|both|bottom|break-all|break-word|capitalize|center|char|circle|cjk-ideographic|col-resize|collapse|content-box|crosshair|dashed|decimal-leading-zero|decimal|default|disabled|disc|distribute-all-lines|distribute-letter|distribute-space|distribute|dotted|double|e-resize|ellipsis|fixed|georgian|groove|hand|hebrew|help|hidden|hiragana-iroha|hiragana|horizontal|ideograph-alpha|ideograph-numeric|ideograph-parenthesis|ideograph-space|inactive|inherit|inline-block|inline|inset|inside|inter-ideograph|inter-word|italic|justify|katakana-iroha|katakana|keep-all|left|lighter|line-edge|line-through|line|list-item|loose|lower-alpha|lower-greek|lower-latin|lower-roman|lowercase|lr-tb|ltr|medium|middle|move|n-resize|ne-resize|newspaper|no-drop|no-repeat|nw-resize|none|normal|not-allowed|nowrap|oblique|outset|outside|overline|pointer|progress|relative|repeat-x|repeat-y|repeat|right|ridge|row-resize|rtl|s-resize|scroll|se-resize|separate|small-caps|solid|square|static|strict|super|sw-resize|table-footer-group|table-header-group|tb-rl|text-bottom|text-top|text|thick|thin|top|transparent|underline|upper-alpha|upper-latin|upper-roman|uppercase|vertical-ideographic|vertical-text|visible|w-resize|wait|whitespace|zero".split("|")),
g=i.arrayToMap("aqua|black|blue|fuchsia|gray|green|lime|maroon|navy|olive|orange|purple|red|silver|teal|white|yellow".split("|")),k=[{token:"comment",merge:!0,regex:"\\/\\*",next:"ruleset_comment"},{token:"string",regex:'["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]'},{token:"string",regex:"['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']"},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("em")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("ex")},{token:"constant.numeric",
regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("px")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("cm")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("mm")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("in")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("pt")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("pc")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+
a("deg")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("rad")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("grad")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("ms")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("s")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("hz")},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"+a("khz")},
{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))%"},{token:"constant.numeric",regex:"\\-?(?:(?:[0-9]+)|(?:[0-9]*\\.[0-9]+))"},{token:"constant.numeric",regex:"#[a-fA-F0-9]{6}"},{token:"constant.numeric",regex:"#[a-fA-F0-9]{3}"},{token:function(a){return b.hasOwnProperty(a.toLowerCase())?"support.type":f.hasOwnProperty(a.toLowerCase())?"support.function":e.hasOwnProperty(a.toLowerCase())?"support.constant":g.hasOwnProperty(a.toLowerCase())?"support.constant.color":"text"},regex:"\\-?[a-zA-Z_][a-zA-Z0-9_\\-]*"}],
n=i.copyArray(k);n.unshift({token:"rparen",regex:"\\}",next:"start"});k=i.copyArray(k);k.unshift({token:"rparen",regex:"\\}",next:"media"});var j=[{token:"comment",merge:!0,regex:".+"}],o=i.copyArray(j);o.unshift({token:"comment",regex:".*?\\*\\/",next:"start"});var p=i.copyArray(j);p.unshift({token:"comment",regex:".*?\\*\\/",next:"media"});j=i.copyArray(j);j.unshift({token:"comment",regex:".*?\\*\\/",next:"ruleset"});this.$rules={start:[{token:"comment",merge:!0,regex:"\\/\\*",next:"comment"},{token:"lparen",
regex:"\\{",next:"ruleset"},{token:"string",regex:"@media.*?{",next:"media"},{token:"keyword",regex:"#[a-zA-Z0-9-_]+"},{token:"variable",regex:"\\.[a-zA-Z0-9-_]+"},{token:"string",regex:":[a-zA-Z0-9-_]+"},{token:"constant",regex:"[a-zA-Z0-9-_]+"}],media:[{token:"comment",merge:!0,regex:"\\/\\*",next:"media_comment"},{token:"lparen",regex:"\\{",next:"media_ruleset"},{token:"string",regex:"\\}",next:"start"},{token:"keyword",regex:"#[a-zA-Z0-9-_]+"},{token:"variable",regex:"\\.[a-zA-Z0-9-_]+"},{token:"string",
regex:":[a-zA-Z0-9-_]+"},{token:"constant",regex:"[a-zA-Z0-9-_]+"}],comment:o,ruleset:n,ruleset_comment:j,media_ruleset:k,media_comment:p}};k.inherits(a,f);g.CssHighlightRules=a});
define("ace/mode/matching_brace_outdent",["require","exports","module","ace/range"],function(b,g){var k=b("ace/range").Range,i=function(){};(function(){this.checkOutdent=function(b,a){return/^\s+$/.test(b)?/^\s*\}/.test(a):!1};this.autoOutdent=function(b,a){var c=b.getLine(a).match(/^(\s*\})/);if(!c)return 0;var c=c[1].length,d=b.findMatchingBracket({row:a,column:c});if(!d||d.row==a)return 0;d=this.$getIndent(b.getLine(d.row));b.replace(new k(a,0,a,c-1),d)};this.$getIndent=function(b){return(b=b.match(/^(\s+)/))?
b[1]:""}}).call(i.prototype);g.MatchingBraceOutdent=i});
define("ace/worker/worker_client",["require","exports","module","pilot/oop","pilot/event_emitter"],function(b,g){var k=b("pilot/oop"),i=b("pilot/event_emitter").EventEmitter,f=function(a,c,d,f){this.callbacks=[];if(b.packaged)a=this.$guessBasePath(),this.$worker=new Worker(a+c);else{var e=this.$normalizePath(b.nameToUrl("ace/worker/worker",null,"_"));this.$worker=new Worker(e);e={};for(c=0;c<a.length;c++){var g=a[c],i=this.$normalizePath(b.nameToUrl(g,null,"_").replace(/.js$/,""));e[g]=i}}this.$worker.postMessage({init:!0,
tlns:e,module:d,classname:f});this.callbackId=1;this.callbacks={};var k=this;this.$worker.onerror=function(a){throw window.console&&console.log&&console.log(a),a;};this.$worker.onmessage=function(a){a=a.data;switch(a.type){case "log":window.console&&console.log&&console.log(a.data);break;case "event":k._dispatchEvent(a.name,{data:a.data});break;case "call":var b=k.callbacks[a.id];b&&(b(a.data),delete k.callbacks[a.id])}}};(function(){k.implement(this,i);this.$normalizePath=function(a){return a.match(/^\w+:/)||
...
{});this.$worker.terminate()};this.send=function(a,b){this.$worker.postMessage({command:a,args:b})};this.call=function(a,b,d){if(d){var f=this.callbackId++;this.callbacks[f]=d;b.push(f)}this.send(a,b)};this.emit=function(a,b){this.$worker.postMessage({event:a,data:b})}}).call(f.prototype);g.WorkerClient=f});namespace.module("com.pageforest.editor.ace",function(b){var g,k=!1,i=window.require("ace/mode/javascript").Mode,f=window.require("ace/mode/javascript").Mode,a=window.require("ace/mode/css").Mode,c=window.require("ace/mode/html").Mode,d=window.require("ace/mode/xml").Mode;b.extend({createEditor:function(){$("#ace").css("height",window.innerHeight-43+"px");$("#ace").css("width",window.innerWidth+"px");g=ace.edit("ace");g.renderer.$horizScrollAlwaysVisible=!1;$(".ace_print_margin").remove();g.session.setWrapLimitRange(80,
80)},loadFile:function(b,e){var k=b.toLowerCase();k.substr(-5)==".html"?g.getSession().setMode(new c):k.substr(-4)==".xml"?g.getSession().setMode(new d):k.substr(-3)==".js"?g.getSession().setMode(new i):k.substr(-5)==".json"?g.getSession().setMode(new f):k.substr(-4)==".css"?g.getSession().setMode(new a):g.getSession().setMode(new c);g.getSession().setValue(e)},adjustHeight:function(){},getData:function(){return g.getSession().getValue()},editor:g,view:function(a){return a=="show"?(k=!0,$("#ace").css("visibility",
