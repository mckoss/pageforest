...
""),a.substr(0,1)=="{"&&JSON.parse(a).status==200&&c(i.app_id))}function e(){var e=window.location.hash;if(e==i.hash)i.editor.adjustHeight();else{i.hash=e;var h=e.substr(1).split("/");console.log("parts: ["+h+"]");e=h.shift();h=h.join("/");console.log("app_id: ["+e+"]");e?e!=i.app_id?(c(e),h?d(h):i.filename=""):h!=i.filename&&d(h):a()}}function l(){console.log("setEditor()");if(i.editor.view()){var a=i.editor.getData();i.editor.view("hide");i.editor=i[$("#editor").val()];i.editor.loadFile(i.filename,
a);i.editor.view("show")}else i.editor=i[$("#editor").val()]}function m(){$("#ace").css("height",window.innerHeight-43+"px");$("#ace").css("width",window.innerWidth+"px");$("#textarea").css("height",window.innerHeight-43+"px");$("#textarea").css("width",window.innerWidth+"px")}var i={};b.extend({onReady:function(){var a=namespace.lookup("com.pageforest.client");i.client=new a.Client(b);i.client.saveInterval=0;i.client.state="clean";i.hash="###";i.app_id="";i.filename="";setInterval(e,200);setInterval(h,
