...
/* Begin file: data.js */
global_namespace.define('startpad.data',function(NS){var DateUtil=NS.lookup('startpad.date-util');var Timer=NS.lookup('startpad.timer');var JSON=NS.lookup('JSON');var Base=NS.lookup('startpad.base');var Event=NS.lookup('startpad.events');var Format=NS.lookup('startpad.format-util');NS.extend(NS,{sSiteName:"web",apikey:undefined,sid:undefined,afn:[],ifn:1,mMessages:{errBusy:"Call made while another call is in progress."},SetSiteName:function(sName)
