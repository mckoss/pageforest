...
else{var formatted="client error: "+message+' ('+status+')';console.log(formatted);}},poll:function(){if(this.state=='init'){if(this.app.getDoc){this.setCleanDoc(undefined,true);}}
