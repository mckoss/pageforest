...
$('#pfMore').toggleClass("expanded collapsed");if($(this.appPanel).is(':visible')){this.positionAppPanel('hide');return false;}else{this.positionAppPanel('show');return true;}},positionAppPanel:function(animation){if(animation==undefined&&!$(this.appPanel).is(':visible')){return;}
var rcAppBox=dom.getRect($('#pfAppBarBox')[0]);dom.slide(this.appPanel,vector.lr(rcAppBox),animation);},showError:function(message){var rcAppBox=dom.getRect($('#pfAppBarBox')[0]);if(this.errorPanel==undefined){return;}
