...
this.checkUsername();this.checkDoc();},checkUsername:function(){var sessionUser=cookies.getCookie('sessionuser');var usernameLast=this.username;if(sessionUser!=undefined){if(sessionUser!=this.username){this.username=sessionUser;this.log('signed in as '+this.username);if(this.app.onUserChange){this.app.onUserChange(this.username);}}}else{if(this.username){this.username=undefined;if(this.app.onUserChange){this.app.onUserChange(this.username);}}}},checkDoc:function(){if(this.saveInterval==0){return;}
