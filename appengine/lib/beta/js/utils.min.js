...
Function.prototype.methods=function(obj){extendObject(this.prototype,obj);};Function.methods({fnMethod:function(obj){var _fn=this;return function(){return _fn.apply(obj,arguments);};},fnArgs:function(){var _fn=this;var _args=copyArray(arguments);return function(){var args=copyArray(arguments).concat(_args);return _fn.apply(this,args);};},fnWrap:function(fn){var _fn=this;return function(){return _fn(this,fn,arguments);};}});Namespace.methods({define:function(closure){this._isDefined=true;this._closure=closure;if(namespaceT.logLevel<=1){console.info("Namespace '"+this._path+"' defined.");}
...
field.name.slice(1);}
var fieldPatterns=base.extendIfMissing({},self.patterns[field.type],base.project(self.style,['label','content']));var row={label:fieldPatterns.label.format(field),content:fieldPatterns.conten.format(field)};var rowPattern=field.useRow?this.style[field.useRow]:this.style.row;stb.append(rowPattern.format(row));});this.content=stb.toString();var s=format.replaceKeys(sDialog,this);return s;},bindFields:function(){if(this.bound){return;}
