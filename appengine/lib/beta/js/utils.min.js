...
docid=this.ensureDocid(docid||this.docid||json.docid);this.stateSave=this.state;this.changeState('saving');var self=this;this.storage.putDoc(docid,json,function(result){result.docid=docid;result.owner=json.owner||this.username;self.onSaveSuccess(result);});},ensureDocid:function(docid){if(docid){return docid;}
