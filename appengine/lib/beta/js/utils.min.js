...
docid=docid||this.docid;if(docid==undefined){docid=format.slugify(json.title);}
...
if(options.hasOwnProperty('obj')){console[options.level](message,options.obj);}else{console[options.level](message);}},errorHandler:function(xmlhttp,textStatus,errorThrown){if(this.stateSave){this.changeState(this.stateSave);this.stateSave=undefined;}
