...
this.appBar.innerHTML=htmlAppBar;var self=this;$('#pfSignIn').click(function(){self.signInOut();});function onSaveClose(){self.toggleAppPanel(false);if(!self.isDirty()){self.checkDoc();}
self.save();}
