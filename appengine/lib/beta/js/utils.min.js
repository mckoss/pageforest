...
this.log('clean doc: '+docid);window.location.hash=docid;this.lastHash=window.location.hash;window.location.href=window.location.href;},checkDoc:function(){if(this.saveInterval==0){return;}
