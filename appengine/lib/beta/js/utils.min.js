...
var url=new URL('/channel/');url.push('uid',this.client.uid);var self=this;this.client.onInfo('channel/init',"Intializing new channel.");$.ajax({url:url.toString(),error:this.errorHandler.fnMethod(this),success:function(result,textStatus,xmlhttp){result.expires=new Date().getTime()+
...
var url=new URL('/channel/subscriptions/');url.push('uid',this.client.uid);var self=this;$.ajax({type:'PUT',url:url.toString(),dataType:'json',data:jsonToString(this.subscriptions),error:this.errorHandler.fnMethod(this),success:function(result,textStatus,xmlhttp){self.client.onInfo('channel/updated',"Subscriptions updated: "+
...
this.appHost=window.location.host;var dot=this.appHost.indexOf('.');this.appid=this.appHost.substr(0,dot);this.wwwHost='www'+this.appHost.substr(dot);this.state='init';this.username=undefined;this.fLogging=true;this.logged={};this.lastHash='';this.fFirstPoll=true;this.uid=random.randomString(20);this.saveInterval=60;this.autoLoad=false;setInterval(this.poll.fnMethod(this),ns.pollInterval);window.onbeforeunload=this.beforeUnload.fnMethod(this);}
