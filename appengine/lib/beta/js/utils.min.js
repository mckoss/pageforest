...
this.bound=true;var self=this;self.dlg=document.getElementById(self.id);base.forEach(this.fields,function(field){field.elt=document.getElementById(field.id);if(field.onClick!=undefined){dom.bind(field.elt,'click',function(){field.onClick();});}
