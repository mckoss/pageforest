...
return res;}
function forEach(a,fn){if(a instanceof Array){for(var i=0;i<a.length;i++){if(a[i]!=undefined){fn(a[i],i);}}
return;}
for(var prop in a){if(a.hasOwnProperty(prop)){fn(a[prop],prop);}}}
