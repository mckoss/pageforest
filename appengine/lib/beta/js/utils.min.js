...
pushParam('method','list');var simpleOptions=['depth','keysonly','prefix'];for(var i=0;i<simpleOptions.length;i++){var option=simpleOptions[i];if(options[option]!=undefined){pushParam(option,options[option]);}}
if(options.encoding){pushParam('transfer-encoding',options.encoding);}
