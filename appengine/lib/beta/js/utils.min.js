...
this.setCleanDoc(undefined,true);setInterval(this.poll.fnMethod(this),ns.pollInterval);$(window).bind('beforeunload',this.beforeUnload.fnMethod(this));}
Client.methods({load:function(docid){if(this.isDirty()){if(!this.confirmDiscard()){return;}
