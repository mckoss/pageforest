...
return this.url+'?'+this.params.join('&');}});function jsonToString(json){var s;var badProperty;function mapper(key,value){if(key&&key[0]=='_'){return undefined;}
if(badProperty){return value;}
