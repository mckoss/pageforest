...
var ptUR=[dom.getRect($('#pfAppBarBox')[0])[2],-4];dom.slide(this.appPanel,ptUR,animation,fnCallback);},showError:function(message){if(this.errorPanel==undefined){return;}
var ptUR=[dom.getRect($('#pfAppBarBox')[0])[2],-4];if(message==undefined){dom.slide(this.errorPanel,ptUR,'hide');return;}
