...
if(options.hasOwnProperty('obj')){console[options.level](message,options.obj);}else{console[options.level](message);}},errorHandler:function(xmlhttp,textStatus,errorThrown){var message;if(this.state=='loading'&&this.emptyDoc){this.app.setDoc(this.emptyDoc);}
