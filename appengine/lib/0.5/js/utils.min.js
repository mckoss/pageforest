...
if(this.app.onUserChange&&usernameLast!=this.username){this.log('found user: '+this.username);this.app.onUserChange(this.username||'anonymous');}},checkData:function(){if(this.saveInterval==0){return;}
