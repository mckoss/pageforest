...
parts[0]=appId;else
parts.splice(0,0,appId);return parts.join('.');},getString:function(url,fn){console.log("getString: "+url);$.getJSON('http://'+url+'?callback=?',fn);},closeForm:function(){function closeFinal(){window.close();}
if(ns.appId)
