...
ns.getString(ns.appDomain+"/auth/username",function(username){if(typeof(username)=='string'){ns.closeForm();return;}});},transferSession:function(sessionKey){ns.getString(ns.appDomain+"/auth/set-session/"+sessionKey,function(s){if(typeof(s)!='string'){alert(s.message);return;}
