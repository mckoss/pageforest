...
function onSuccess(message,status,xhr){$(document.body).addClass('user');$('.username').text(username);getSessionKey(function(){if($('#id_appauth').attr('checked')){transferSessionKey(closeForm);}});}
