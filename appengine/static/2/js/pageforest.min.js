...
function onReady(){dlg=new dialog.Dialog({fields:[{name:'username'},{name:'password',type:'password'},{name:'allowAccess',label:"Allow Access to "+appId,type:'checkbox'},{name:'signIn',label:"Sign In",type:'button',onClick:onSubmit}],style:dialog.styles.table});$('#sign-up-dialog').html(dlg.html());dlg.setFocus();$('#enablejs').hide();$('input').removeAttr('disabled');if(cookies.getCookie('httponly')){$('#httponly').show();}
