...
function onSubmit(){var username=$('#id_username').val();var password=$('#id_password').val();var data={username:username,password:crypto.HMAC(crypto.SHA1,username,password),appauth:$('#id_appauth').attr('checked')?'checked':''};forms.postFormData(window.location.pathname,data,onSuccess,onValidate,onError);return false;}
